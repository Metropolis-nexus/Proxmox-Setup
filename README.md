...
- Datacenter -> Roles -> Add MetropolisVMUser -> `Pool.Audit VM.Audit VM.Backup VM.Config.CDROM VM.Config.HWType VM.Config.Options VM.Console VM.GuestAgent.Audit VM.GuestAgent.FileRead VM.GuestAgent.FileSystemMgmt VM.GuestAgent.FileWrite VM.GuestAgent.Unrestricted VM.PowerMgmt VM.Snapshot VM.Snapshot.Rollback`
